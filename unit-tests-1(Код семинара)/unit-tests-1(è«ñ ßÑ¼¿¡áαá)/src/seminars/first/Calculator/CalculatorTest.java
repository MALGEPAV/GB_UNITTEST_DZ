...
public class CalculatorTest {
    public static void main(String[] args) {
        ...
        Offset<Double> offset = Assertions.offset(0.001);
        //ДЗ1, Задание1: Проверка метода calculatingDiscount:
        assertThat(Calculator.calculatingDiscount(100, 20))
                .isEqualTo(80, offset);
        assertThat(Calculator.calculatingDiscount(20, 100))
                .isEqualTo(0, offset);
        assertThat(Calculator.calculatingDiscount(10, 0))
                .isEqualTo(10, offset);
        assertThatThrownBy(() -> Calculator.calculatingDiscount(10, -5))
                .isInstanceOf(ArithmeticException.class);
        assertThatThrownBy(() -> Calculator.calculatingDiscount(-4, 10))
                .isInstanceOf(ArithmeticException.class);
